...
const GlassButton: React.FC<{ children: React.ReactNode; href?: string; onClick?: () => void }> = ({ children, href, onClick }) => (
  <GlassEffect
    href={href}
    className="rounded-3xl px-8 py-5 hover:px-9 hover:py-6 hover:rounded-[2rem] overflow-hidden"
...
const GlassCard: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className = "" }) => (
  <GlassEffect className={`rounded-2xl p-6 ${className}`}>
    {children}
  </GlassEffect>
);
...
export { GlassEffect, GlassDock, GlassButton, GlassCard, GlassFilter };
